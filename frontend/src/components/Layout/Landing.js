        ...
        <div className="min-h-screen bg-white font-sans text-slate-900">
            ...
            <nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
                <div className="flex items-center gap-3">
                    <div
                        className="bg-white p-1 rounded-xl shadow-sm border-2 border-blue-100 flex items-center justify-center overflow-hidden w-10 h-10 transition-colors hover:border-blue-400">
                        <img
            ...
            <span
                className="inline-block px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-blue-100">
              Humanitarian Response v3.0
                        ...
                        <p className="text-lg text-slate-500 max-w-lg mb-10 leading-relaxed">
                            Інтелектуальна система підтримки прийняття рішень для розподілу гуманітарних ресурсів в
                            Україні на основі матриці пріоритетів та Weighted Max-Min Fairness.
                        </p>
                    ...
                    <div className="relative">
                        ...
                        <div
                            className="relative bg-white border border-slate-200 rounded-3xl shadow-2xl p-4 overflow-hidden transform rotate-2">
                ...
                <div className="max-w-7xl mx-auto px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            ...
                            <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">Товарів на
                                складі
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-black text-blue-600 mb-2">{stats.requests || 0}</div>
                            <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">Активних
                                заявок
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-black text-slate-900 mb-2">{stats.warehouses || 0}</div>
                            <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">Локальних
                                хабів
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-black text-emerald-500 mb-2">99.9%</div>
                            <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">Точність
                                розподілу
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-32">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="text-center max-w-2xl mx-auto mb-20">
                        ...
                        <p className="text-slate-500 font-medium">Цифрова платформа для координації логістики під час
                            дефіциту критичних ресурсів.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i}
                                 className="p-8 rounded-3xl border border-slate-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50 transition-all group">
                                <div
                                    className="bg-slate-50 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-50 transition-colors">
                                    {f.icon}
                                </div>
            ...
            <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
                    ...
                    <div
                        className="absolute bottom-10 right-10 w-64 h-64 bg-indigo-500 rounded-full blur-[100px]"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-8 relative z-10">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div className="max-w-xl">
                            ...
                            <p className="text-slate-400 font-medium">Ми автоматизували процес прийняття рішень, щоб
                                виключити корупцію та помилки при розподілі ресурсів.</p>
                        </div>
                        <div className="hidden md:block">
                            <span
                                className="text-[100px] font-black text-white/5 leading-none select-none">STEP-BY-STEP</span>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                step: "01",
                                title: "Реєстрація",
                                desc: "Заявник подає запит із вказанням мети (Військові, ВПО, Медицина)."
                            },
                            {
                                step: "02",
                                title: "Пріоритезація",
                                desc: "Система призначає ваговий коефіцієнт на основі категорії терміновості."
                            },
                            {
                                step: "03",
                                title: "Max-Min Розрахунок",
                                desc: "Алгоритм обчислює оптимальну частку для кожного запиту при дефіциті."
                            },
                            {
                                step: "04",
                                title: "Видача",
                                desc: "Формується автоматичний накладний лист для відвантаження зі складу."
                            }
                        ].map((s, i) => (
                            <div key={i} className="relative">
                                ...
                                {i < 3 && <div className="hidden lg:block absolute top-8 -right-6 text-blue-500/30">
            ...
            <section className="pb-32 px-8">
                <div
                    className="max-w-5xl mx-auto bg-gradient-to-r from-slate-900 to-blue-900 rounded-[2.5rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-blue-900/20">
                    {/* Декоративна сітка */}
                    <div className="absolute top-0 left-0 w-full h-full opacity-10">
                        <div
                            className="absolute top-[-50%] left-[-10%] w-[100%] h-[200%] bg-[radial-gradient(circle,white_1px,transparent_1px)] [background-size:30px_30px]"></div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 relative z-10">
                        ...
                        <div
                            className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mt-2 opacity-80">
            ...
            <footer className="py-12 bg-slate-900 text-center">
               ...
               ResQ <span className="text-blue-500">System</span>
                    ...
                    <p className="text-slate-400 text-sm">© 2026 ResQ Humanitarian Systems Ukraine. Всі права
                        захищено.</p>
                </div>
            </footer>
        </div>
